        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            {/* Offered even when a `local` twin exists, and that is the boundary
                ...
                object that was observed. `local` supplies this card's LABEL and
                thumbnail only; if a later artifact took the slug, the label is
                the stale part, which is why the confirm's operative sentence
                names the folder rather than the label. On the picker the row IS
                a local artifact and no cloud object has been observed at all, so
                the target would be inferred from the ledger -- that surface gets
                no removal, pinned by its own test. */}
