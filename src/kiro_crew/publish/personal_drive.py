...
class PersonalDriveProvider(PublishProvider):
    ...
    async def serving_notice(self, *, external_id: str) -> tuple[str, str] | None:
        ...
        try:
            ...
            status, _domain2 = engine.distribution_status(dist_id, profile)
        except (PublishError, engine.AWSError, json.JSONDecodeError, ValueError) as exc:
    ...
    def _serving_notice(self, dist_id: str, status: str, profile: str) -> tuple[str, str]:
    ...
    def _assert_serving(self, dist_id: str, status: str, profile: str) -> None:
        ...
        notice, _code = self._serving_notice(dist_id, status, profile)
        if notice:
        ...
        def _work() -> tuple[str, str, str, str, str, str]:
            ...
            if public:
                ...
                try:
                    ...
                    notice, notice_code = self._serving_notice(dist_id, status, profile)
