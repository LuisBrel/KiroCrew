...
def _is_shell_command_wrapper(argv: list[str]) -> bool:
    ...
    if proc_root.is_dir():
        for entry in proc_root.iterdir():
            ...
            if cmd:
                ...
                # for why dropping the wrapper costs no coverage.
                if _is_shell_command_wrapper(argv):
                    continue
